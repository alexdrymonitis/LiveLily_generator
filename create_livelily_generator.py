...
if len(sys.argv) < 2:
  print("Usage: ./create_livelily_generator.py /path/to/corpus.txt")
  exit()
...
start = time.time()
states = None
next_char = tf.constant(['\\bar', '\\bar', '\\bar', '\\bar', '\\bar'])
result = [next_char]
...
tf.saved_model.save(one_step_model, model_name)
